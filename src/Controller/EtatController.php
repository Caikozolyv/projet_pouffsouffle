...
class EtatController extends AbstractController
{
    ...
    /**
     * @Route("/{idEtat}", name="etat_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idEtat}/edit", name="etat_edit", methods={"GET","POST"})
     */
    ...
    /**
     * @Route("/{idEtat}", name="etat_delete", methods={"DELETE"})
     */
    public function delete(Request $request, Etat $etat): Response
    {
        if ($this->isCsrfTokenValid('delete'.$etat->getIdEtat(), $request->request->get('_token'))) {
            $entityManager = $this->getDoctrine()->getManager();
